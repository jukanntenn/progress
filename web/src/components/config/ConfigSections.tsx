import type { FieldSchema, SectionSchema } from "@/lib/api";
...
export function ConfigSections({ sections, configDraft, onConfigChange }: ConfigSectionsProps) {
  return (
